...
- Name: full-ui.spec.ts >> 5. Composer >> 5.8 Helper text visible
- Location: e2e/full-ui.spec.ts:397:3
...
Locator: locator('text=/Shift\\+Enter|Drag & drop/i')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/Shift\\+Enter|Drag & drop/i')
